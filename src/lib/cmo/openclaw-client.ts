...
function appTurnBody(
  ...
  return {
    ...
    sessionLocalSources: contextPackage.sessionLocalSources ?? [],
    activeSourceId: contextPackage.activeSourceId,
...
function runtimeBody(contextPackage: CMOContextPackage) {
  return {
    ...
    session_local_sources: contextPackage.sessionLocalSources ?? [],
    active_source_id: contextPackage.activeSourceId,
