...
export interface HermesCmoChatMetadata {
  ...
  endpointKind?: "execute" | "tool_execute" | "agent_chat" | "cmo_agent";
  ...
  routeReason?: string;
  route_reason?: string;
  workflowKind?: "weekly_campaign";
  workflow_kind?: "weekly_campaign";
  workflow_contract?: "cmo.weekly_campaign_workflow.v1";
  failureStage?: "request_preparation" | "hermes_execute";
  failure_stage?: "request_preparation" | "hermes_execute";
  safeFailureReason?: string;
  safe_failure_reason?: string;
  default_channel_scope?: "cross_channel";
  route?: unknown;
  ...
  reference_asset_fetch_status?: string;
  local_image_path_available?: boolean;
  creative_visual_inspection_attempted?: boolean;
  creative_visual_inspection_used?: boolean;
  creative_visual_inspection_status?: string;
  creative_visual_inspection_error?: string;
  creative_answer_source?: string;
  creative_visual_observations?: unknown;
  creative_post_generation_visual_inspection_attempted?: boolean;
  creative_post_generation_visual_inspection_used?: boolean;
  creative_post_generation_visual_inspection_status?: string;
  creative_post_generation_visual_metadata?: unknown;
