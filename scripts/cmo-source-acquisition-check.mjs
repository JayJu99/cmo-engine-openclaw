...
try {
  ...
  assert.match(appChatStoreSource, /durableSideEffectsSuppressed = hermesCmoChatV11Attempted/);
  assert.match(appChatStoreSource, /status === "completed" && !durableSideEffectsSuppressed \? await runVaultAgentDryRunHandoff/);
